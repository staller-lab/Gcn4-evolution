...
def predict():
    ...
    tiles_df['activity'] = tiles_df.apply(lambda row: row['Activity_ratioA'] if row['Activity_ratioA'] else row['Activity_ratioB'], axis=1)
    ...
    #save
    tiles_df.to_csv('./predict-tiles-31.csv')
